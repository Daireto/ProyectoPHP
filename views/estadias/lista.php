            ...
            <div class="lista-contenedor">
                <div class="lista-encabezado">
                    ...
                    <div class="lista-opciones">
                        <a href="?url=estadias&accion=crear">Crear estadía</a>
                    </div>
                </div>
                <table>
                    <thead>
                    ...
                    <tbody>
                        ...
                        <?php foreach($this->estadias as $estadia): ?>
                            <tr class="registro">
                                ...
                                <td class="opciones">
                                    <a class="ver" href="?url=estadias&accion=ver&id=<?php echo $estadia['codigo'] ?>">Ver</a>
                                    <a class="editar" href="?url=estadias&accion=editar&id=<?php echo $estadia['codigo'] ?>">Editar</a>
                                    <a class="eliminar" href="?url=estadias&accion=eliminar&id=<?php echo $estadia['codigo'] ?>">Eliminar</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                    ...
                    <div class="paginacion">
                        <div class="cantidad-registros">
                            <?php
                                ...
                                $rango = "Mostrando ".($inicio+1)."-".$final." estadias";
                            ?>
                            <span><?php echo $rango ?></span>
                        </div>
                        <div class="opciones">
                            <?php if ($page > 1): ?>
                                <a href="?url=estadias&page=<?php echo $page - 1 ?>">Anterior</a>
                            <?php endif ?>
                            <?php if ($page < $_GET['pages']): ?>
                                <a href="?url=estadias&page=<?php echo $page + 1 ?>">Siguiente</a>
                            <?php endif ?>
                        </div>
                    </div>
                <?php endif ?>

        ...
        <section class="crear-editar">
            <div class="formulario-contenedor">
                ...
                <?php if (isset($this->errors) && count($this->errors) > 0): ?>
                    ...
                    <?php endforeach ?>
                <?php endif ?>
                <form action="?url=estadias&accion=crear" method="post">
                    <div class="campo-formulario">
                        <label>Placa</label>
                        <input type="text" id="placa" name="placa" value="<?php echo mostrar_campo('placa') ?>" required>
                    </div>
                    <div class="campo-formulario">
                        <label>Cédula</label>
                    ...
                    <div class="campo-formulario">
                        ...
                        <input type="datetime-local" id="fecha_ingreso" name="fecha_ingreso" value="<?php echo mostrar_campo('fecha_ingreso') ?>" required>
                    </div>
                    <div class="campo-formulario">
                        <label>Fecha de salida</label>
                        <input type="datetime-local" id="fecha_salida" name="fecha_salida" value="<?php echo mostrar_campo('fecha_salida') ?>" required>
                    </div>

                ...
                <form action="?url=usuarios&accion=editar&id=<?php echo $this->usuario['cedula'] ?>" method="post">
                    ...
                    <div class="campo-formulario">
                        ...
                        <select class="campo" id="rol" name="rol" required>
                            ...
                            <?php endforeach ?>
                            <!-- <option value="Usuario" <?php echo (mostrar_campo('rol') ?? $this->usuario['rol']) == 'Usuario' ? 'selected' : '' ?>>Usuario</option>
                            <option value="Admin" <?php echo (mostrar_campo('rol') ?? $this->usuario['rol']) == 'Admin' ? 'selected' : '' ?>>Admin</option> -->
                        </select>
                    </div>
